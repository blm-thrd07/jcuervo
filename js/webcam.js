...
var protochttps=location.protocol.match(/https/i) ? 'https' : 'http';
window.webcam = {
	version: '1.0.9',
	...
	swf_url: protochttps +'://apps.t2omedia.com.mx/php2/jcuervo/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : location.protocol.match(/https/i) ? 'https' : 'http' + '://apps.t2omedia.com.mx/php2/jcuervo/js/shutter.mp3';
	},
