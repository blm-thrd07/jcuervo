...
class UsuariosComicsComentariosController extends Controller
{
	/**
	...
	public function actionDelete($id)
	{
		...
		if($this->loadModel($id)->delete()){
          ...
          $modelUsuariosComics=UsuariosComicsComentarios::model()->findAll(array('condition'=>'tbl_comics_id=:cid','params'=>array(':cid'=>$modelcomicid)));
           
          echo count($modelUsuariosComics);
           /*
	...
	{
		$dataProvider=new CActiveDataProvider('UsuariosComicsComentarios');
	...
	{
		$model=new UsuariosComicsComentarios('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UsuariosComicsComentarios']))
			$model->attributes=$_GET['UsuariosComicsComentarios'];
	...
	{
		$model=UsuariosComicsComentarios::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='usuarios-comics-comentarios-form')
		{
