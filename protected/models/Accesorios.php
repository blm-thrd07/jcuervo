 ...
 * @property TblTipoAccesorios $idTipoAccesorio
 */
class Accesorios extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, id_tipo_accesorio', 'required'),
			array('id, id_tipo_accesorio', 'numerical', 'integerOnly'=>true),
			array('url', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, id_tipo_accesorio, url', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idTipoAccesorio' => array(self::BELONGS_TO, 'TblTipoAccesorios', 'id_tipo_accesorio'),
		);
	}
