...
<?php $this->widget('zii.widgets.grid.CGridView', array(
  ...
  'columns'=>array(
    ...
    /*array(
    //  CHtml::link(CHtml::image(Yii::app()->request->baseUrl."/Comics/".$data["imagen"], "", array("style"=>"height:100px;")),Yii::app()->request->baseUrl."/Comics/".$data["imagen"]) ',
      'value'=> 'CHtml::link("Borrar", "./delete/".$data->id, "")',
      'type'=>'raw',
    ),*/
  ),
));
