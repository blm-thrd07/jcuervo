...
Yii::app()->getClientScript()->registerScript('registrar', '
  ...
  if(edit){
    for(var a in avatar_accesorios){
      insertarAccesorio(parseInt(avatar_accesorios[a].posx),parseInt(avatar_accesorios[a].posy),parseInt(avatar.avatarPiezas[a].rotation),parseInt(avatar_accesorios[a].accesorios_id),'.TiposPiezas::ACCESORIO.',avatar_accesorios[a].accesorioImg);
    }
