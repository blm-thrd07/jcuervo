...
<div style="float:'left';">
	<a href="<?php echo CController::createUrl('app/admin').'/admin/adminusuarios'; ?>">Usuarios Admin</a>
</div>
<div style="float:'left';">
	<a href="<?php echo CController::createUrl('app/admin').'/admin/admincomics'; ?>">Comics Admin</a>
</div>
